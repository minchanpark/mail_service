...
import { buildThreadId, formatAttachmentSize } from "@/services/server/providers/helpers";
import { compactThreadForStorage } from "@/other/utils/thread-persistence";
import type {
  MailProviderDriver,
  PreparedAccount,
  SendMailInput,
  SendMailReceipt,
  SyncInboxOptions,
} from "@/services/server/providers/types";
import type {
  AccountProvider,
